...
class TodosTest {
    ...
    @Test
    public void shouldCheckSearchAllFalse() {  //проверка на пустой массив {}
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
        ...
        Task[] expected = {};
        Task[] actual = todos.search("Изучить");
        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void shouldCheckSearchMeeting() {  //граничное значение 1
        SimpleTask simpleTask = new SimpleTask(5, "Купить Хлеб");
